...
`data_service_sdk.*` is the public import namespace for `1.5.0`. The existing `framework.*` namespace remains available as a compatibility layer for current integrations.
